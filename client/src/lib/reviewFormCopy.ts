...
const copy: Record<StorefrontLocale, ReviewFormCopy> = {
  ...
  it: {
    ...
    success: "Grazie! La tua recensione sarà pubblicata dopo la verifica.",
  ...
  es: {
    ...
    success: "¡Gracias! Tu opinión se publicará tras su validación.",
  ...
  nl: {
    ...
    success: "Bedankt! Uw beoordeling wordt na controle gepubliceerd.",
  ...
  ar: {
    ...
    success: "شكراً! سيتم نشر تقييمك بعد المراجعة.",
