...
import { ArrowLeft, ArrowRight, CheckCircle2, CircleAlert, ClipboardCheck, Eye, FileText, Globe2, Image, LockKeyhole, Paintbrush, Package, ShieldCheck } from "lucide-react";
...
const itemIcons = { identity: Paintbrush, pages: FileText, media: Image, catalogue: Package, domain: Globe2, private_preview: Eye, public_opening: LockKeyhole };
const stateStyles = {
