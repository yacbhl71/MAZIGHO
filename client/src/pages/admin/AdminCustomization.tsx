...
export default function AdminCustomization() {
  ...
  const initialTab = ["style", "menu", "home", "images", "sections", "footer"].includes(hashTab) ? hashTab : "style";
    ...
    <DashboardLayout>
      <div className="space-y-6 pb-8">
        ...
        <Tabs key={initialTab} defaultValue={initialTab} className="space-y-5">
          <TabsList className="h-auto flex-wrap justify-start gap-1 bg-transparent p-0"><TabsTrigger value="style" className="gap-2 border data-[state=active]:border-violet-200 data-[state=active]:bg-violet-50"><Palette className="h-4 w-4" /> Style</TabsTrigger><TabsTrigger value="menu" className="gap-2 border data-[state=active]:border-violet-200 data-[state=active]:bg-violet-50"><LayoutPanelTop className="h-4 w-4" /> Menu</TabsTrigger><TabsTrigger value="home" className="gap-2 border data-[state=active]:border-violet-200 data-[state=active]:bg-violet-50"><LayoutPanelTop className="h-4 w-4" /> Accueil</TabsTrigger><TabsTrigger value="images" className="gap-2 border data-[state=active]:border-violet-200 data-[state=active]:bg-violet-50"><ImagePlus className="h-4 w-4" /> Images</TabsTrigger><TabsTrigger value="sections" className="gap-2 border data-[state=active]:border-violet-200 data-[state=active]:bg-violet-50"><Eye className="h-4 w-4" /> Sections</TabsTrigger><TabsTrigger value="footer" className="gap-2 border data-[state=active]:border-violet-200 data-[state=active]:bg-violet-50"><LayoutPanelTop className="h-4 w-4" /> Footer</TabsTrigger></TabsList>
