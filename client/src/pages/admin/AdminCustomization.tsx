...
export default function AdminCustomization() {
  ...
  const initialTab = ["style", "menu", "home", "images", "catalogue", "product", "checkout", "sections", "footer"].includes(hashTab) ? hashTab : "style";
