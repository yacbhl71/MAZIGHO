...
import { ArrowLeft, BadgeCheck, CircleAlert, ClipboardCheck, Eye, LayoutDashboard, LockKeyhole, PackageOpen, Palette, Settings2, ShoppingBag, Sparkles, UsersRound } from "lucide-react";
