...
export default function Checkout() {
  ...
  const shippingEstimate = calculateCheckoutShippingEstimate(subtotal, shippingPolicyQuery.data);
  const shipping = shippingEstimate.shippingAmountCents;
