...
const faqItemInput = z.object({
  ...
  // Individual incomplete drafts are intentionally accepted here then removed
  // by normalizeFaqItems. This lets a tablet owner clean up a row instead of
  // having one unfinished question block the entire FAQ save.
